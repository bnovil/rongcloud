...
//        System.out.println("checkOnline:  " + userCheckOnlineResult.toString());
        ...
        VoiceMessage messagePublishPrivateVoiceMessage = new VoiceMessage("hello", "helloExtra", 5L);
        CodeSuccessResult messagePublishPrivateResult = rongCloud.message.publishPrivate("4700299477", messagePublishPrivateToUserId, messagePublishPrivateVoiceMessage, "thisisapush", "{\"pushData\":\"hello\"}", "4", 0, 0, 0, 0);
